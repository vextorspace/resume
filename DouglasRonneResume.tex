...
\begin{center}
    ...
    \vspace{2mm}
    101 W Olympic Pl \#306 | Seattle, WA, 98119\\
...
I am collaborative, driven by the success of my team, take responsibility, and have an adaptive-flexible approach to problem solving. In addition to being very technically capable I am a skilled communicator and easy to get along with. I am driven to solve problems for the people around me whether my colleagues or customers. I love embedded software, motor control, sensors and measurement, and productivity. I am a citizen of both the U.S.A. and Canada.
...
% -- Amazon- Apex
\noindent
\textbf{Embedded Software Engineer - Apex Amazon}, Seattle, WA, United States \hfill \textit{February 2025 - August 2025}
\begin{itemize}[leftmargin=*,itemsep=0pt, parsep=0pt,label=$\diamond$]
\item Found and corrected deficiencies in control scheme of prior BLDC motor control software leading to high current use
\item Worked with team to design new board for a specific application
\item Created motor control software for initial prototype that uses 30\% the power as previous version and is quieter
\item Also helped broader team work through some difficult problems. I do not believe my responsibility to a project is restricted to my specialty
\end{itemize}
...
\noindent
\textbf{Building an AI Application}, Goto Masterclass \hfill \textit{2024}

\noindent
\textbf{Goto Conference, Chicago} \hfill \textit{2024}
